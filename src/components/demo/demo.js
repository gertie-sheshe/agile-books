			...
			<div className="sections">
				...
				<div className="section section-to-read">
					...
					<div className="body-section">
						<div draggable onDragStart={(event) => this.onDragStart(event, title)}>
							<p>{title}</p>
						</div>
					</div>
				</div>
				<div className="section section-reading">
					...
					<div onDrop={(event) => this.onDrop(event, "reading")} onDragOver={(e) => this.onDragOver(e)} className="body-section">
